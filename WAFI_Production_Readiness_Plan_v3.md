...
| Ticket | Title | Priority | Effort | What It Builds |
|---|---|---|---|---|
| WAFI-151 | Projection Rebuild & Event Recovery | P1 | ~~1 sprint~~ **stale — see Macro-Phase 3 status row above; split into Plan 1 (shipped) + Plan 2 (not started)** | `Rebuild Dashboard` → Replay Events → Recreate Read Models. Corruption recovery command |
