...
| WAFI-005, WAFI-008 through WAFI-015, WAFI-017, WAFI-018, WAFI-020 (remaining Macro-Phase 1) | ⬜ Not started | Confirmed via a code audit 2026-07-27 (not just a doc re-read) — no matching implementation found for any of these. **WAFI-011 (discount-aware refunds) is the one worth prioritizing**: `useReturnSheet.ts` has no discount handling at all today, which is a real financial-correctness gap (a discounted sale's return currently refunds the pre-discount price), not just a missing feature. |
...
| WAFI-011 | Discounts + Returns Net Price Refund | P2 | 0.5 sprint | Refund post-discount price, prorated breakdown. **Confirmed not started 2026-07-27** — `useReturnSheet.ts` has no discount handling at all; a discounted sale's return currently refunds the pre-discount price. Highest-priority remaining P2 — real financial-correctness gap, not just a missing feature. |
...
**Foundation Total: 23 tickets | 8 weeks** — **8 of 23 fully shipped (WAFI-203, WAFI-002, WAFI-003, WAFI-004, WAFI-007, WAFI-016, WAFI-022, WAFI-023), 2 already satisfied with no code change (WAFI-006, WAFI-019), 1 shipped pending only founder signatures (WAFI-001), 1 partially shipped (WAFI-021, 3 of 7 docs), 12 not started (WAFI-005, WAFI-008 through WAFI-015, WAFI-017, WAFI-018, WAFI-020).**
