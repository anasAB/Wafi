...
const modules: Array<{
  ...
  // WAFI-146: the /dashboard "why did this move" screen has no slot in the
  // fixed 5-tab bottom nav (AppBottomNav.vue), so it's reachable on mobile
  // from here instead — the same "more" surface /reports would use if it
  // were wired up.
  { key: 'dashboard2', label: 'لوحة التحكم', description: 'تحليل التغيرات في الإيرادات والربح', route: '/dashboard', active: true, permission: 'can_view_reports' },
      ...
      <div class="nav-list">
        ...
        >
          ...
          <div class="nav-icon-wrap">
            ...
            <svg v-if="mod.key === 'dashboard2'" xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
