  ...
  <div class="page-root">
    ...
    <div class="filter-bar" dir="rtl">
      ...
      <div class="filter-row">
        ...
        <div class="search-wrap">
          ...
          <!-- WAFI-127: numeric-first keyboard (receipt numbers are mostly digits;
               the prefix stays typeable), placeholder teaches the format -->
          <input
            v-model="searchQuery"
            type="text"
            inputmode="numeric"
            class="search-input"
            placeholder="رقم الفاتورة… مثال: A1-000045 أو 45"
    ...
    <main class="page-main">
      ...
      <div v-else-if="sales.length === 0" class="empty-state">
        ...
        <!-- WAFI-127: a failed receipt search needs guidance, not a generic empty -->
        <template v-if="searchQuery.trim()">
          <p class="empty-text">لم يتم العثور على الفاتورة</p>
          <p class="empty-text">تحقق من الرقم — وقد تكون الفاتورة من متجر أو جهاز آخر</p>
        </template>
        <template v-else>
