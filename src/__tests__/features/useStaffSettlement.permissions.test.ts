...
function staffWith(role: Staff['role'], canViewExpenses: boolean): Staff {
  return {
    ...
    permissions: { can_view_reports: false, can_manage_products: true, can_manage_customers: true, can_view_expenses: canViewExpenses, can_manage_settings: false, can_manage_inventory: false, can_manage_suppliers: false, can_manage_stock_take: false, can_view_staff_ledger: false, can_view_staff_performance: false },
